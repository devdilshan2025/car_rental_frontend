...
const CarCard = ({ car }) => {
    ...
    const carImageUrl = `https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80&w=400`; // Default fallback
            ...
            <div className="card h-100 shadow-sm border-0 rounded-4 overflow-hidden" style={{ backgroundColor: '#eef2ff' }}>
                ...
                <div className="card-body p-4">
                    ...
                    <div className="mt-4 d-flex justify-content-between align-items-center">
                        ...
                        <button 
                            className={`btn rounded-pill px-4 fw-bold shadow-sm ${car.isAvailable ? 'btn-primary' : 'btn-outline-secondary disabled'}`}
                        >
